...
funcionários=[{'código de funcionário':'11','nome':'samuel','email':'neymarjr@gmail.com',
               'data de admissão':'2011','salário':'R$ 14.000.000'},
              {'código de funcionário':'7','nome':'lucas','email':'cristiano@gmail.com',
               'data de admissão':'1997','salário':'R$ 183.000.000'},
            {'código de funcionário':'10','nome':'davi','email':'messi@gmail.com',
...
if escolha==4:
    ...
    while True:
        if 'samuel' in demitido:
            del funcionários[0]
            break
        elif 'lucas' in demitido:
            del funcionários[1]
            break
        elif 'davi' in demitido:
            del funcionários[2]
            break
        else:
...
if escolha==5:
    ...
    while True:
        if 'samuel' in funcionário_aumento:
            ...
            break
        elif 'lucas' in funcionário_aumento:
            ...
            break
        elif 'davi' in funcionário_aumento:
